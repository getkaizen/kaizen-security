...
```
[PASS] exfil-to-allowed-host: 2/2
[PASS] undeclared-capability: 1/1
[PASS] sensitive-read-then-egress: 2/2

Detection scorecard: Kaizen caught 5/5 red-team actions (100%).
```
